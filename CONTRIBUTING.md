# Contributing to Story DKG TEE

Thank you for considering making contributions to Story DKG TEE and related repositories! Below you can find what's the best way that you can help.
...
* PR title and body follows [conventional commit][3].
   ...
   - Scope must be concise: only a one or two folders; e.g. 'server' or 'service' or '*'
...
feel free to [file an issue](https://github.com/piplabs/story-kernel/issues/new).
...
[1]: https://github.com/piplabs/story-kernel/issues
