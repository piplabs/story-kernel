...
// OpenHCL) are intentionally out of scope for story-kernel; the upstream
// Linux driver rejects them with "Invalid offer 3" in dmesg and
// configfs-tsm returns ENXIO on those hosts.
//
// Probe semantics:
//
