...
// acquisition. Each vendor sub-package (currently only "direct") implements
// one Vendor and registers itself in this package's global registry from
// its init() function.
//
...
// code is negligible compared to the TDX module + Linux kernel that
// dominates the TCB measurement.
package platform
