...
// TestFinalizeDKGRegion_SerializedWithLateResponse exercises the #87 mutex-coverage
...
// TestGenerateDealsRegion_SerializedWithProcessDeal exercises the #87 fix on the
